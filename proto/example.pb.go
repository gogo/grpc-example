...
func (m *UpdateUserRequest) GetUpdateMask() *google_protobuf3.FieldMask {
	if m != nil {
		return m.UpdateMask
	}
	return nil
...
func (*ListUsersRequest) Descriptor() ([]byte, []int) { return fileDescriptorExample, []int{3} }
...
func (m *ListUsersRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CreatedSince != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintExample(dAtA, i, uint64(types.SizeOfStdTime(*m.CreatedSince)))
		n4, err := types.StdTimeMarshalTo(*m.CreatedSince, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.OlderThan != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintExample(dAtA, i, uint64(types.SizeOfStdDuration(*m.OlderThan)))
		n5, err := types.StdDurationMarshalTo(*m.OlderThan, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *ListUsersRequest) Size() (n int) {
	...
	_ = l
	if m.CreatedSince != nil {
		l = types.SizeOfStdTime(*m.CreatedSince)
		n += 1 + l + sovExample(uint64(l))
	}
	if m.OlderThan != nil {
		l = types.SizeOfStdDuration(*m.OlderThan)
		n += 1 + l + sovExample(uint64(l))
	}
	return n
}
...
func (m *ListUsersRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := types.StdTimeUnmarshal(m.CreatedSince, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := types.StdDurationUnmarshal(m.OlderThan, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
